...
public class HangmanGame{
    private final String WORD_FILE_PATH = "D:\\Programming\\NetBeansProjects\\ID1212_Task1\\src\\server\\model\\HangmanWords.txt";
    ...
    public HangmanGame(){
        loader = new WordLoader(WORD_FILE_PATH);
        score = 0;
        lostWon = 2;
    }
    
    public Serializable updateState(){
